...
The most useful for me are below.
...
```
Especially quick terminal, which requires allowing ghostty to control computer, setting found at System Settings > Privacy and Security > Accessibility.